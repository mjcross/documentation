...
RM2 is approved for use in the following regions:
...
In the *EU*, *UK*, *USA*, and *Canada*, manufacturers of host devices (products that integrate RM2) can leverage RM2's existing certification to simplify and reduce additional approval requirements. This is called *full modular approval* and means that you don't have to conduct full radio certification in these regions; you can integrate RM2 into your product with minimal additional testing.

In *India* and *Malaysia*, modular approval isn't granted. This means that RM2's certification applies only to the radio module itself; it doesn't extend to host devices that incorporate it. Any host device containing RM2 must obtain its own separate approval.
